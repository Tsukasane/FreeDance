...
# class QuantizeEMAReset2D(nn.Module): # Dealing with B, H, T, D inputs
#     def __init__(self, nb_code, code_dim, args):
#         super().__init__()
#         self.nb_code = nb_code
#         self.code_dim = code_dim
...
#     def forward(self, x):
#         B, D, T, H = x.shape # TODO(yw) check the input shape
...
#         # Postprocess
#         x_d = x_d.view(B, T, H, -1).permute(0, 3, 1, 2).contiguous()   #BTHD -> BDTH
