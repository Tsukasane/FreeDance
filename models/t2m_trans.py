...
class Music2Dance_Transformer(nn.Module):
    def __init__(self, 
        ...
        self.n_head = n_head
        self.trans_base = CrossCondTransBase(vqvae, num_vq, embed_dim, clip_dim, block_size, num_layers, num_local_layer, n_head, drop_out_rate, fc_rate)
        self.trans_head = CrossCondTransHead(num_vq, embed_dim, block_size, num_layers, n_head, drop_out_rate, fc_rate) #NOTE(yw) a classification head
        self.block_size = block_size
        self.num_vq = num_vq
...
class CrossCondTransBase(nn.Module):
    ...
    def __init__(self, 
        ...
        self.cond_emb = nn.Linear(clip_dim, embed_dim) # motion and cond to the same dim 
